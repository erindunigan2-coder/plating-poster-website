...
export const MANUALS: Manual[] = [
  ...
  {
    id: "watts-nickel-manual",
    title: "Watts Nickel — The Complete Training Manual",
    titleEs: "Níquel Watts — El Manual de Capacitación Completo",
    seriesId: "watts-nickel",
    seriesLabel: "Watts Nickel",
    tagline: "A full training course for the brand-new operator — assumes you know nothing, teaches you everything.",
    description:
      "A 46-page, plain-language training manual for the entire plain Watts nickel (engineering nickel) line — written in a friendly, beginner-friendly style that assumes zero prior knowledge. Covers every station from cleaning to post-treatment with the “why” behind each step, a deep-dive chapter on the Watts bath itself (contamination control, anode selection, Hull Cell diagnostics, internal stress, and the hydrogen-embrittlement bake), integrated safety, teach-back checklists, and trainer sign-offs. Ends with a 20-question completion test with safety-gate questions, answer key, and a printable certificate of completion.",
    descriptionEs:
    ...
    languages: ["en", "es"],
    coverImage: "/manuals/watts-nickel-manual-cover.jpg",
    coverImageEs: "/manuals/watts-nickel-manual-cover-es.jpg",
    samplePages: [
      "/manuals/samples/watts-nickel-manual-p1.jpg",
      "/manuals/samples/watts-nickel-manual-p2.jpg",
      "/manuals/samples/watts-nickel-manual-p3.jpg",
      "/manuals/samples/watts-nickel-manual-p4.jpg",
      "/manuals/samples/watts-nickel-manual-p5.jpg",
      "/manuals/samples/watts-nickel-manual-p6.jpg",
    ],
    highlights: [
      "Zero-assumption fundamentals primer — what plating is and how the line works",
      "All 8 stages: cleaning → rinse → acid activation → rinse → Watts plating → rinse → post-treatment → final rinse/dry",
      "“Plain Watts is NOT bright nickel” — why matte is success, and why you never “fix” it with brightener",
      "Deep-dive Watts bath chapter: contamination watch list, S-Rounds vs. non-sulfur anodes, Hull Cell read for soundness, internal stress, and the ASTM B850 hydrogen-embrittlement bake",
      "Safety integrated into every station (PPE, nickel dermatitis, acids, LOTO)",
      "Teach-back checklists + trainer sign-off boxes at every station",
      "20-question completion test with safety-gate questions, answer key, and certificate of completion",
      "Available in English and Spanish (professional shop-floor Spanish)",
    ],
    available: true,
  },
  {
    id: "semi-bright-nickel-manual",
    title: "Semi-Bright Nickel — The Complete Training Manual",
    titleEs: "Níquel Semibrillante — El Manual de Capacitación Completo",
    seriesId: "semi-bright-nickel",
    seriesLabel: "Semi-Bright Nickel",
    tagline: "A full training course for the brand-new operator — assumes you know nothing, teaches you everything.",
    description:
      "A 56-page, plain-language training manual for the entire semi-bright nickel line — the sulfur-free, leveled base layer of the duplex decorative stack. Written in a friendly, beginner-friendly style that assumes zero prior knowledge, it covers every station from cleaning to stack completion, with a dedicated chapter on the duplex system and the STEP test (why the bright layer sacrifices itself to protect the base), the sulfur-free leveler system (coumarin and coumarin-free), the semi-bright/bright firewall discipline, contamination control, anode selection, internal stress and ductility, and the hydrogen-embrittlement bake. Integrated safety, teach-back checklists, and trainer sign-offs throughout. Ends with a 20-question completion test with safety-gate questions, answer key, and a printable certificate of completion.",
    descriptionEs:
      "Un manual de capacitación de 56 páginas, en lenguaje sencillo, para toda la línea de níquel semibrillante — la capa base nivelada y libre de azufre del sistema dúplex decorativo. Escrito en un estilo amigable para principiantes que no asume conocimientos previos, cubre cada estación desde la limpieza hasta completar el sistema, con un capítulo dedicado al sistema dúplex y la prueba STEP (por qué la capa brillante se sacrifica para proteger la base), el sistema nivelador libre de azufre (cumarina y libre de cumarina), la disciplina del muro de contención semibrillante/brillante, el control de contaminación, la selección de ánodos, el esfuerzo interno y la ductilidad, y el horneado de alivio de hidrógeno. Seguridad integrada, listas de verificación y firmas del entrenador. Termina con un examen de 20 preguntas con filtros de seguridad, clave de respuestas y un certificado de finalización imprimible.",
    pages: 56,
    priceDigital: 299,
    pricePrint: 329,
    priceCombo: 369,
    ...
    languages: ["en", "es"],
    coverImage: "/manuals/semi-bright-nickel-manual-cover.jpg",
    coverImageEs: "/manuals/semi-bright-nickel-manual-cover-es.jpg",
    samplePages: [
      "/manuals/samples/semi-bright-nickel-manual-p1.jpg",
      "/manuals/samples/semi-bright-nickel-manual-p2.jpg",
      "/manuals/samples/semi-bright-nickel-manual-p3.jpg",
      "/manuals/samples/semi-bright-nickel-manual-p4.jpg",
      "/manuals/samples/semi-bright-nickel-manual-p5.jpg",
      "/manuals/samples/semi-bright-nickel-manual-p6.jpg",
    ],
    highlights: [
      "Zero-assumption fundamentals primer — what plating is and how a duplex line works",
      "All 8 stages: cleaning → rinse → acid activation → rinse → semi-bright plating → rinse → stack completion → final rinse/dry",
      "The duplex system chapter: why the layer nobody sees decides the corrosion life — STEP test (ASTM B764), sacrificial bright layer, ASTM B456 stack",
      "The sulfur-free leveler system: coumarin vs. coumarin-free, amp-hour dosing, breakdown products, and the carbon-treatment schedule",
      "The semi-bright/bright firewall: the two-nickel-chemistry discipline no other line needs",
      "Deep-dive bath chapter: contamination watch list, anode selection for a sulfur-free layer, leveling-panel diagnostics, internal stress, and the ASTM B850 hydrogen-embrittlement bake",
      "Safety integrated into every station (PPE, nickel dermatitis, acids, LOTO)",
      "Teach-back checklists + trainer sign-off boxes at every station",
      "20-question completion test with safety-gate questions, answer key, and certificate of completion",
      "Available in English and Spanish (professional shop-floor Spanish)",
  ...
  {
    id: "acid-copper-manual",
    title: "Acid Copper — The Complete Training Manual",
    titleEs: "Cobre Ácido — El Manual de Capacitación Completo",
    seriesId: "acid-copper",
    posterPrefixes: ["acid-copper"],
    seriesLabel: "Acid Copper",
    tagline: "A full training course for the brand-new operator — assumes you know nothing, teaches you everything.",
    description:
      "A 48-page, plain-language training manual for the entire acid copper sulfate plating line — written in a friendly, “for-dummies”/beginner-friendly style that assumes zero prior knowledge. Covers every station from cleaning through the copper strike, acid copper plating, and post-treatment/QC — the leveling heart of decorative nickel-chrome and PCB copper. Explains the “why” behind each step: why acid copper immersion-blisters on bare steel and must be struck first, the parts-per-million chloride window, the suppressor/accelerator/leveler additive system, phosphorized-copper anodes, and the hydrogen-embrittlement bake. Safety is integrated into every station — including the co-equal cyanide vs. non-cyanide strike and the lethal acid-plus-cyanide (HCN) hazard. Ends with a 20-question completion test, answer key, and a printable certificate of completion.",
    descriptionEs:
    ...
    languages: ["en", "es"],
    coverImage: "/manuals/acid-copper-manual-cover.jpg",
    coverImageEs: "/manuals/acid-copper-manual-cover-es.jpg",
    samplePages: [
      "/manuals/samples/acid-copper-manual-p1.jpg",
      "/manuals/samples/acid-copper-manual-p2.jpg",
      "/manuals/samples/acid-copper-manual-p3.jpg",
      "/manuals/samples/acid-copper-manual-p4.jpg",
      "/manuals/samples/acid-copper-manual-p5.jpg",
      "/manuals/samples/acid-copper-manual-p6.jpg",
    ],
    highlights: [
      "Zero-assumption fundamentals — what plating is, and why acid copper levels better than any common bath",
      "All 8 stations: cleaning → rinse → acid activation → copper strike → acid copper → post-treatment/QC",
      "The rule everyone learns the hard way: strike first, or acid copper immersion-blisters on steel/zinc/aluminum",
      "The parts-per-million chloride window, the suppressor/accelerator/leveler additives, and phosphorized-copper anodes",
      "Completes the decorative triad (Copper → Bright Nickel → Chromium), plus the PCB/high-throw role",
      "Safety integrated into every station — including the co-equal cyanide vs. non-cyanide strike and the lethal acid+cyanide (HCN) hazard",
      "Teach-back checklists + “top mistakes new operators make”",
      "20-question completion test, answer key, and certificate of completion",
    ],
    available: true,
