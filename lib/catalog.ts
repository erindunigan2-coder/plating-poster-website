...
export const CATEGORIES: CategoryEntry[] = [
  ...
  },
  {
    ...
    totalPosters: 64,
    processes: [
      { id: pid("Sulfuric Acid Anodizing (Type II)"), title: "Sulfuric Acid Anodizing (Type II)", posterCount: 8, available: true },
      { id: pid("Hardcoat Anodizing (Type III)"), title: "Hardcoat Anodizing (Type III)", posterCount: 8, available: true },
      { id: pid("Chromic Acid Anodizing (Type I)"), title: "Chromic Acid Anodizing (Type I)", posterCount: 8, available: true },
      { id: pid("Boric-Sulfuric Acid Anodizing (BSAA)"), title: "Boric-Sulfuric Acid Anodizing (BSAA)", posterCount: 8, available: true },
      { id: pid("Phosphoric Acid Anodizing (PAA)"), title: "Phosphoric Acid Anodizing (PAA)", posterCount: 8, available: true },
      { id: pid("Bright Anodizing"), title: "Bright Anodizing", posterCount: 8, available: true },
      { id: pid("Integral Color Anodizing"), title: "Integral Color Anodizing", posterCount: 8, available: true },
      { id: pid("Two-Step (Electrolytic) Color Anodizing"), title: "Two-Step (Electrolytic) Color Anodizing", posterCount: 8, available: true },
    ],
  },
  {
    id: "electroless",
    ...
    processes: [
      ...
      { id: pid("Electroless Nickel (Mid Phosphorus)"), title: "Electroless Nickel (Mid Phosphorus)", posterCount: 8, available: true },
      { id: pid("Electroless Nickel (High Phosphorus)"), title: "Electroless Nickel (High Phosphorus)", posterCount: 8, available: true },
  ...
  },
  {
    ...
    totalPosters: 64,
    processes: [
      { id: pid("Iron Phosphate"), title: "Iron Phosphate", posterCount: 8, available: true },
      { id: pid("Zinc Phosphate"), title: "Zinc Phosphate", posterCount: 8, available: true },
      { id: pid("Manganese Phosphate"), title: "Manganese Phosphate", posterCount: 8, available: true },
      { id: pid("Chromate Conversion (Hexavalent)"), title: "Chromate Conversion (Hexavalent)", posterCount: 8, available: true },
      { id: pid("Chromate Conversion (Trivalent)"), title: "Chromate Conversion (Trivalent)", posterCount: 8, available: true },
      { id: pid("Aluminum Conversion Coating (Chem Film / Alodine)"), title: "Aluminum Conversion Coating (Chem Film / Alodine)", posterCount: 8, available: true },
      { id: pid("Black Oxide (Steel)"), title: "Black Oxide (Steel)", posterCount: 8, available: true },
      { id: pid("Passivation (Stainless Steel)"), title: "Passivation (Stainless Steel)", posterCount: 8, available: true },
    ],
  },
  {
