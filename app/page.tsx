...
const THREE_WAYS = [
  ...
  },
  {
    ...
    description:
      "Go beyond the wall. Complete, plain-language operator training manuals — the why behind every step, integrated safety, a completion test, and a certificate. English & Spanish.",
    href: "/manuals",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
